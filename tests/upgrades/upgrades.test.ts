...
import { LocalTestnetAddresses, AdvanceBlockTime, shellLog, shellBackground, shell } from "../utils.js"
...
describe("Contract updates test", () => {
  ...
  it("should generate contract state and store it", async function () {
    const { CloneFactory, Implementation, Lumerin } = require("../../test-temp/build-js/dist/index.js")
