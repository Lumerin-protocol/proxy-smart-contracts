...
function createContractObject(web3, name) {
    ...
    //let contractAddress = contract.networks['5777']['address'] //for testing only
    let contractAddress = contract.networks['3']['address'] //for ropsten
    let contractABI = contract.abi
    return new web3.eth.Contract(contractABI, contractAddress)
}

function createLumerin(web3) {
    let contract = getContractJSON('Lumerin')
    let contractABI = contract.abi
    return new web3.eth.Contract(contractABI, '0x84E00a18a36dFa31560aC216da1A9bef2164647D')
}
