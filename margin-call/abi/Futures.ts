export const FuturesABI = [
  ...
  {
    inputs: [],
    name: "buyerLiquidationMarginPercent",
    outputs: [
      {
        internalType: "uint8",
        name: "",
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint8",
        name: "_sellerLiquidationMarginPercent",
        type: "uint8",
      },
      {
        internalType: "uint8",
        name: "_buyerLiquidationMarginPercent",
        type: "uint8",
      },
      {
        internalType: "uint256",
  ...
  {
    inputs: [],
    name: "sellerLiquidationMarginPercent",
    outputs: [
      {
        internalType: "uint8",
        name: "",
